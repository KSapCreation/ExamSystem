Public Class Evaluator
   ...
   Private mExtraFunctions As Object
    Public type As Integer = 0  ' O from Head Part, 1 for DetailPart
      ...
      Public Sub NextToken()
        ...
        Public Sub ParseIdentifier()
            ...
            While mCurChar <> "#"
                value.Append(mCurChar)
                NextChar()
                If mCurChar = "#" Then NextChar() : Exit While
            End While
      ...
      Private Function InternalGetVariable() As Object
         ...
         Do
            ...
            ElseIf parameters.Count = 0 Then
               ...
               valueleft = Nothing
                    Try
                        If mEvaluator.type = 0 Then
                            mEvaluator.RaiseGetVariable(func, valueleft)
                        Else
                            mEvaluator.RaiseGetVariableGrid(func, mEvaluator.Rownum, valueleft)
                        End If
   ...
   End Function
    ...
    Private Sub RaiseGetVariable(ByVal name As String, ByRef value As Object)
        ...
        End If
    End Sub
    Private Sub RaiseGetVariableGrid(ByVal name As String, Row_Index As Integer, ByRef value As Object)
        RaiseEvent GetVariableGrid(name, Row_Index, value)
        If TypeOf value Is Single Or TypeOf value Is Integer Then
            value = CDbl(value)
        End If
    End Sub
    ...
    Event GetVariableGrid(ByVal name As String, Row_Index As Integer, ByRef value As Object)
End Class