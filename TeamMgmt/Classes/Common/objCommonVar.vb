...
#Region "Variables"
    Private Shared _CurrentTicketNo As String = ""
    Private Shared _CurrentTicketOrAllocationScreen As String = ""
    Private Shared _currOpenRequestNo As String = ""
    Private Shared _currUserCode As String = ""
    Private Shared _currUserName As String = ""
    Private Shared _currUserType As String = ""
    Private Shared _currClientCode As String = ""
...
#End Region
    ...
    End Property
    '_CurrentTicketNo
    Public Shared Property CurrentTicketOrAllocationScreen() As String
        Get
            Return _CurrentTicketNo
        End Get
        Set(ByVal Value As String)
            _CurrentTicketNo = Value
        End Set
    End Property
    '
    Public Shared Property CurrentOpenRequestNo() As String
        Get
            Return _currOpenRequestNo
        End Get
        Set(ByVal Value As String)
            _currOpenRequestNo = Value
        End Set
    End Property

    Public Shared Property CurrentTicketNo() As String
        Get
            Return _CurrentTicketOrAllocationScreen
        End Get
        Set(ByVal Value As String)
            _CurrentTicketOrAllocationScreen = Value
        End Set
    End Property
    ...
    Public Shared Property CurrentClientCode() As String
        Get
            Return _currClientCode
        End Get
        Set(ByVal Value As String)
            _currClientCode = Value
        End Set
    End Property
